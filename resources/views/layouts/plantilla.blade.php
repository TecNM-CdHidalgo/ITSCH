...
<div class="row enc">
  ...
  <div class="col-sm-5">
        ...
        <a href="https://tecitsch-my.sharepoint.com/:f:/g/personal/academica_cdhidalgo_tecnm_mx/IgBn2bizuACtS6wQaVK-trzkATQp99-O9xAvKHYrYGDuRaY?e=H9A8Ju" title="Horarios del semestre" target="_blank">
    ...
    <div class="collapse navbar-collapse " id="collapsibleNavBlanco" >
        ...
        <li class="nav-item dropdown  ml-4">
            ...
            <div class="dropdown-menu">
                ...
                <a class="dropdown-item" href="{{ route('transparencia.indicadores') }}">Indicadores de resultados</a>
                <a class="dropdown-item" href="{{ route('transparencia.reportes') }}">Informe U079</a>
            </div>
        </li>
