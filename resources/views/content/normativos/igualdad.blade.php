            ...
            <div class="col-sm-4">
                <div class="card" style="width:300px">
                    ...
                    <div class="card-body">
                      ...
                      <p class="card-text" style="text-align: justify; font-family: 'Montserrat'; font-size: 14px;">El código de ética será aplicable a todas las personas que desempeñen un empleo, cargo o comisión, al interior de alguna dependencia o entidad de la Administración Pública Federal, o bien, en alguna empresa productiva del Estado. <br> <b>Leer mas...</b> <br><br><br><br><br></p>
