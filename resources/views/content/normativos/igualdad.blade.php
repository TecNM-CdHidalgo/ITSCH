...
@section('content')
    ...
    <div class="container">
      ...
      <section class="pt-5">
        ...
        <div class="wow fadeIn">
          <!--Section heading-->
          <h2 class="h1 text-center mb-5"></h2>
          <!--Section description-->
          <p class="text-center"> ¿Sabias
            que…?</p>
          <p class="text-center mb-5 pb-5">De acuerdo a la Norma Mexicana NMX-R-025-SCFI-2015, la IGUALDAD es:
        ...
        <div class="row wow fadeIn">
	        ...
	        <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
	            <h3 class="mb-3 font-weight-bold dark-grey-text">
	              <strong>NORMA MEXICANA
	                NMX-R-025-SCFI-2015
	                EN IGUALDAD LABORAL Y
	                NO DISCRIMINACIÓN</strong>
	            </h3>
	            <p class="grey-text">El Código de Ética será
	              aplicable a todas las
	              personas que desempeñen
	              un empleo, cargo o
	              comisión, al interior de
	              alguna dependencia o
       ...
       <!--Grid row-->
        ...
        <div class="row wow fadeIn">
           ...
           <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
             ...
             <p class="grey-text">En México se viene
              promoviendo de manera
              independiente y apegada a
              las leyes que les rigen, el
        ...
        <div class="row wow fadeIn">
          ...
          <!--Grid column-->
           ...
           <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
             ...
             <p class="grey-text">
              De acuerdo a la Norma Mexicana NMX-R-025-scfi-2015 En Igualdad Laboral
              Y No Discriminación, EL ACOSO SEXUAL ES:
              Es una forma de violencia con connotación lasciva en la que, si bien no
        ...
        <div class="row wow fadeIn">
         ...
         <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
           <h3 class="mb-3 font-weight-bold dark-grey-text">
             <strong>Formato para denuncia de Acoso Sexual</strong>
           </h3>
           <p class="grey-text">
      ...
      <div class="row wow fadeIn">
       ...
       <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
         <h3 class="mb-3 font-weight-bold dark-grey-text">
           <strong>Formato para Denuncia Normas éticas</strong>
         </h3>
         <p class="grey-text">
  ...
  <div class="row wow fadeIn">
   ...
   <div class="col-lg-7 col-xl-7 ml-xl-4 mb-4">
     <h3 class="mb-3 font-weight-bold dark-grey-text">
       <strong>Uso del lenguaje no sexista</strong>
     </h3>
     <p class="grey-text">
