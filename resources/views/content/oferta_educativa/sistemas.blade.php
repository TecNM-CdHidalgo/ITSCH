...
@section('content')
    ...
    <h2> OBJETIVOS EDUCACIONALES: </h2>
        ...
        <tr>
            <td>Generarán soluciones de sistemas de información con altos estándares de calidad, mejorando la gestión de procesos de negocio</td>
            <td>Los egresados desarrollaran software cumpliendo estándares de calidad internacionales.</td>
            <td>El 5% de los egresados desarrollaran </td>
        </tr>
        <tr>
            <td>Innovarán y optimizarán procesos de negocios mediante soluciones seguras e Inteligentes, basados en modernas tecnologías de información y comunicaciones, que generen valor a la organización y a la comunidad.</td>
            <td>Los egresados desarrollaran, innovaran o implementaran soluciones tecnológicas de información o comunicaciones.</td>
            <td>El 30% de los egresados</td>
        </tr>
        <tr>
            <td>Serán líderes de proyectos de sistemas de información y servicios de tecnologías de información y comunicaciones, en equipos de trabajo.</td>
            <td>Los egresados serán líderes de proyectos tecnológicos formando equipos de trabajo.</td>
            <td>El 3% de los egresados</td>
        </tr>

        <tr>
            <td>El egresado desarrolla su profesión con ética y conciencia social.</td>
            <td>Los egresados se desarrollaran de forma ética y con una conciencia social dentro del sector productivo.</td>
            <td>El 20% de los egresados </td>
        </tr>

        <tr>
            <td>El egresado desarrolla actividades de educación continua.</td>
            <td>Los egresados continúan con su formación profesional y de perfil mediante posgrados, certificaciones o especialidades.</td>
            <td>El 10% de los egresados obtendrá algún posgrado, certificación o especialidad afín al programa.</td>
        </tr>
    </table>
    ...
    <br>
    <p align="justify"> Innovarán y optimizarán procesos de negocios mediante soluciones seguras e Inteligentes, basados en modernas tecnologías de información y comunicaciones, que generen valor a la organización y a la comunidad.</p>
    <br>
    <p align="justify"> Serán líderes de proyectos de sistemas de información y servicios de tecnologías de información y comunicaciones, en equipos de trabajo.</p>
    <br>
    <p align="justify">El egresado desarrolla su profesión con ética y conciencia social.</p>
    <br>
    <p align="justify">El egresado desarrolla actividades de educación continua.</p>
    -->
    ...
    <ul>
        ...
        <li>Aplicar, analizar y sintetizar procesos de diseño de ingeniería que resulten en proyectos que
            cumplen las necesidades especificadas.</li>
        <li>Desarrollar y conducir una experimentación adecuada; analizar e interpretar datos y utilizar
            el juicio ingenieril para establecer conclusiones. </li>
        <li>Comunicarse efectivamente con diferentes audiencias.</li>
        <li>Reconocer sus responsabilidades éticas y profesionales en situaciones relevantes para la
            ingeniería y realizar juicios informados, que consideren el impacto de las soluciones de
            ingeniería en los contextos global, económico, ambiental y social.</li>
        <li>Reconocer la necesidad permanente de conocimiento adicional y tener la habilidad para
   ...
   <hr class="red">
    <ul>
        ...
        <li>Diseñar e  implementar interfaces hombre‐máquina y máquina‐máquina para la automatización de sistemas.</li>
        <li> Identificar y comprender las  tecnologías de hardware para proponer, desarrollar y&nbsp;mantener aplicaciones  eficientes.</li>
        <li> Diseñar, desarrollar y administrar  bases de datos conforme a requerimientos&nbsp;definidos, normas  organizacionales de manejo y seguridad de la información,&nbsp;utilizando  tecnologías emergentes.</li>
        <li> Integrar soluciones computacionales  con diferentes tecnologías, plataformas o&nbsp;dispositivos.</li>
        <li> Desarrollar una visión empresarial  para detectar áreas de oportunidad que le permitan&nbsp;emprender y desarrollar  proyectos aplicando las tecnologías de la información y&nbsp;comunicación.</li>
    ...
    <li>Proceso Personal para el Desarrollo de Software</li>
    <li>Modelo de Desarrollo Integral</li>
    <li>Verificación y Validación de Software</li>
    <li>Programación de Móviles</li>




    <p>Se pretende que los alumnos de la carrera de Ingeniería en Sistemas Computacionales del Instituto Tecnológico Superior de Ciudad Hidalgo, desarrollen mediante la Especialidad de Ingeniería de Software un conjunto de habilidades y capacidades que el campo laboral en estos momentos requiere:</p>
    ...
    <li>Conocimiento de matemáticas aplicadas.</li>
    <li>Capacidad de análisis.</li>
    <li>Capacidad de sistematización.</li>
    ...
    <li>Control de Inteligencia Emocional</li>
    <li>Ingenieros en Sistemas Computacionales mejor preparados</li>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr><td>AE034-Fundamentos de Telecomunicaciones.pdf</td><td><a href="{{ asset('images/content/oferta educativa/sistemas/temario/AE034-Fundamentos de Telecomunicaciones.pdf') }}">     <button class="btn btn-primary"  type="button"> <i class='fas fa-download' style='font-size:20px'></i></a></td></tr>
