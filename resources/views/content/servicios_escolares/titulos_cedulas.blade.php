            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a type="button" class="btn btn-primary" href="{{ route('alumnos.adeudos') }}" data-toogle="tooltip" title="Constancia de no Adeudo para alumnos próximos a Titularse." download>
                                <i class='fas fa-download' style='font-size:20px'></i>
                            </a>
                        </td>
                    </tr>
