			...
			<div class="col-md-12 text-center">								
                ...
                <div class="directorio">
					...
					<div class="persona">
						<img src="{{asset('images/userh.png')}}" alt="Foto de persona">
						<div class="info">
							<div class="nombre-puesto">Ing. Miguel Alejandro Correa Becerril - Jefe del Departamento de Servicios Escolares</div>
							<div class="contacto">Correo: <a href="servicios_escolares@cdhidalgo.tecnm.mx">servicios_escolares@cdhidalgo.tecnm.mx</a> | (786) 1549000 ext. 153</div>
						</div>
					</div>
					<div class="persona">
						<img src="{{asset('images/userf.jpg')}}" alt="Foto de persona">
					...
					<div class="persona">
						<img src="{{asset('images/userh.png')}}" alt="Foto de persona">
						<div class="info">
							<div class="nombre-puesto">IQ. Walter Iván Cortéz Cruz - Departamento de Investigación y Ciencias Básicas</div>
