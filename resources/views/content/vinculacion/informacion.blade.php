...
@section('content')
	<div class="row">
		...
		<article class="col-md-8 maincontent">
			...
			<p> Recuerda que cualquier duda, comentario o sugerencia puedes pasar al departamento de Vinculación donde con mucho gusto te atenderemos, estamos para servirte</p>

			<h3>Los servicios de Vinculación, son:</h3>
			<h4 style="margin-left: 49.65pt;">
			•	Residencias Profesionales</h4>
			    <h4 style="margin-left: 49.65pt;">
			•	Servicio Social</h4>    
			    <h4 style="margin-left: 49.65pt;">
			•	Bolsa de Trabajo Institucional</h4> 
			    <h4 style="margin-left: 49.65pt;">
			•	Visitas a Empresas</h4> 
			    <h4 style="margin-left: 49.65pt;">
